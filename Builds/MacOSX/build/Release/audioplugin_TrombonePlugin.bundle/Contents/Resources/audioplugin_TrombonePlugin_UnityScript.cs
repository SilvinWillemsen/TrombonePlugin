...
public class audioplugin_TrombonePluginGUI : IAudioEffectPluginGUI
{
    public override string Name           { get { return "audioplugin_TrombonePlugin"; } }
    public override string Description    { get { return "TrombonePlugin"; } }
    public override string Vendor         { get { return "yourcompany"; } }

    //==============================================================================
    [DllImport("audioplugin_TrombonePlugin")] static extern System.IntPtr getRenderCallback();

    [DllImport("audioplugin_TrombonePlugin")] static extern void unityInitialiseTexture (int id, System.IntPtr texture, int width, int height);

    [DllImport("audioplugin_TrombonePlugin")] static extern void unityMouseDown (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_TrombonePlugin")] static extern void unityMouseDrag (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_TrombonePlugin")] static extern void unityMouseUp   (int id, float x, float y, EventModifiers mods);

    [DllImport("audioplugin_TrombonePlugin")] static extern void unityKeyEvent (int id, KeyCode code, EventModifiers mods, string name);

    [DllImport("audioplugin_TrombonePlugin")] static extern void unitySetScreenBounds (int id, float x, float y, float w, float h);
